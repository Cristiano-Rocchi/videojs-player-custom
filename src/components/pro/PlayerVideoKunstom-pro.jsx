    ...
    if (
      ...
      class GroupedControlsEnd extends Component {
        constructor(player, options) {
          ...
          this.qualityMenuVisible = false; // Indica se il menu qualità è visibile
        }
        ...
        createEl() {
          ...
          settingButton.addEventListener("click", () => {
            if (this.qualityMenuVisible) {
              ...
              // Pulisce il menu prima di aggiungere nuove opzioni
              ...
              if (
                ...
                currentVideo.qualities.forEach((quality) => {
                  ...
                  qualityOption.addEventListener("click", () => {
                    ...
                    qualityMenu.style.display = "none"; // Chiude il menu dopo la selezione
