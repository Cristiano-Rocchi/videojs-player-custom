      ...
      class GroupedControlsStart extends Component {
        ...
        createEl() {
          ...
          const prevButton = videojs.dom.createEl("button", {
            ...
            innerHTML: `<svg width="20px"  viewBox="0 0 56 56" width="56" xmlns="http://www.w3.org/2000/svg"><path d="m9.25 47.0898h5.3203c2.0625 0 3.1172-1.0781 3.1172-3.1406v-15.0703c-.0703-.2813-.1172-.5859-.1172-.8906 0-.3281.0469-.6328.1172-.9141v-15.0469c0-2.1328-1.0547-3.1171-3.1172-3.1171h-5.3203c-2.0625 0-3.1406 1.0781-3.1406 3.1171v31.9219c0 2.0625 1.0781 3.1406 3.1406 3.1406zm37.2657-.7031c1.8514 0 3.3749-1.3828 3.3749-4.0078v-28.7813c0-2.6249-1.5235-4.0312-3.3749-4.0312-.9376 0-1.7344.3047-2.6954.8672l-23.8828 14.0625c-1.2656.75-1.9687 1.6172-2.25 2.5781v1.8047c.2813.9844.9844 1.8282 2.25 2.6016l23.8828 14.039c.961.5625 1.7578.8672 2.6954.8672z"/></svg>`,
          });
